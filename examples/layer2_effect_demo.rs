...
fn main() -> Result<()> {
    ...
    let remote_computation = TransformConstraint::RemoteTransform {
        ...
        target_location: Location::Remote("compute_service".to_string()),
        source_type: TypeInner::Product(
            Box::new(TypeInner::Base(BaseType::Int)),
            Box::new(TypeInner::Base(BaseType::Int))
        ),
    ...
    let data_migration = TransformConstraint::DataMigration {
        ...
        to_location: Location::Remote("backup_service".to_string()),
    ...
    let distributed_sync = TransformConstraint::DistributedSync {
        locations: vec![
            Location::Remote("service_a".to_string()),
            Location::Remote("service_b".to_string()),
            Location::Remote("service_c".to_string()),
        ],
    ...
    intent.location_requirements = LocationRequirements {
        ...
        allowed_locations: {
            ...
            set.insert(Location::Remote("compute_service".to_string()));
            set.insert(Location::Remote("database".to_string()));
            set
        },
        migration_specs: vec![],
        ...
        performance_constraints: causality_core::effect::intent::PerformanceConstraints {
            ...
            cost_constraints: causality_core::effect::intent::CostConstraints {
                max_compute_cost: None,
                max_communication_cost: None,
                max_storage_cost: None,
                optimization_strategy: causality_core::effect::intent::CostOptimizationStrategy::Balanced,
            },
        },
    };
