...
let step_1_compile_dsl () =
  ...
  let ocaml_compile_cmd =
    "cd \
     /Users/hxrts/projects/timewave/reverse-causality/e2e/tests/ocaml_harness \
    ...
    | WEXITED 0 -> (
        ...
        let lisp_compile_cmd =
          "cd /Users/hxrts/projects/timewave/reverse-causality && \
           ...
           e2e/tests/ocaml_harness/bridge_vault_scenario.lisp --output \
...
let step_3_compile_zk_circuit () =
  ...
  let zk_compile_cmd =
    "cd /Users/hxrts/projects/timewave/reverse-causality && \
     ./target/debug/causality zk-compile --input /tmp/bridge_vault.ir --output \
     /tmp/bridge_vault_circuit.zk --privacy-level high --proof-system groth16 \
     --verbose"
  in
  ...
  try
    ...
    | WEXITED 0 ->
        ...
        else Failure "ZK circuit file was not created"
    | WEXITED _ | WSIGNALED _ | WSTOPPED _ ->
...
let step_4_verify_zk_proof () =
  ...
  if witness_exit_code = WEXITED 0 then (
    ...
    let zk_verify_cmd =
      "cd /Users/hxrts/projects/timewave/reverse-causality && \
       ./target/debug/causality zk-verify --circuit \
       /tmp/bridge_vault_circuit.zk --witness-file \
       /tmp/bridge_vault_witness.json --mock-runtime --verbose"
    in
...
let step_5_submit_transactions () =
  ...
  let submit_cmd =
    "cd /Users/hxrts/projects/timewave/reverse-causality && \
     ...
     /tmp/bridge_vault_circuit.zk --proof /tmp/bridge_vault_circuit.zk \
