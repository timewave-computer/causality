(**
 * Basic SSZ types implementation module
 *
 * Implements serialization for primitive types like booleans, integers,
 * and other basic data types used in the SSZ serialization scheme.
 *)
