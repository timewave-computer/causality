...
use crate::capability::resource::{ResourceCapability, ResourceRegistry, InMemoryResourceRegistry};
use crate::concurrency::ResourceManager;
...
/// Utility function to get a mock resource manager.
pub fn get_mock_resource_manager() -> Arc<ResourceManager> { // Return concrete type
    // Assuming ResourceManager::new() exists
