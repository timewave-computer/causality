...
impl OperationManager {
    ...
    pub async fn transfer_resource(
        ...
        let target_resource_id = ResourceId::from_content_id(&resource_id).expect("Valid content ID");
...
pub mod builder {
    ...
    pub fn transfer(
        ...
        builder = builder.with_target(ResourceId::from_content_id(&resource_id).expect("Valid content ID"));
