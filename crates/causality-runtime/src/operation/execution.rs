...
mod tests {
    ...
    async fn test_abstract_executor() {
        ...
        let operation = CoreOperation {
            ...
            target: ResourceId::from_content_id(&ContentId::new("test-target")).expect("Valid content ID"),
    ...
    async fn test_register_executor() {
        ...
        let operation = CoreOperation {
            identity: IdentityId::new("test-identity"),
            operation_type: CoreOperationType::Create,
            target: ResourceId::from_content_id(&ContentId::new("test-register")).expect("Valid content ID"),
            effects: Vec::new(),
            state: OperationState::Pending,
            previous_operations: Vec::new(),
            parameters: HashMap::new(),
    ...
    async fn test_zk_executor() {
        ...
        let operation = CoreOperation {
            ...
            target: ResourceId::from_content_id(&ContentId::new("test-proof-target")).expect("Valid content ID"),
            effects: Vec::new(),
            state: OperationState::Pending,
            previous_operations: Vec::new(),
            parameters: HashMap::new(),
