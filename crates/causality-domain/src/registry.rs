...
// Original file: src/domain/registry.rs
...
use causality_domain::{DomainInfo, DomainType, DomainStatus};
use causality_domain::DomainSelectionStrategy;
...
mod tests {
    ...
    use causality_domain::{FactQuery, TimeMapEntry};
