...
use causality_core::effect::{
    ...
    object::{
        AffineObject, LinearObject, Object, RelevantObject, UnrestrictedObject,
    },
    CapabilityError,
};
...
fn test_object_with_multiple_capabilities() {
    ...
    let obj = LinearObject::linear(42).with_capabilities(caps.clone());
...
fn test_object_creation_patterns() {
    ...
    let caps = vec![Capability::read("test")].into_iter().collect();
