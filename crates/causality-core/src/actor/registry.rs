// Actor registry for discovery and management
// Original file: src/actor/registry.rs
...
use causality_types::{ContentId, ContentHash, TraceId};
use causality_core::{Actor, ActorId, ActorIdBox, ActorRole, ActorState, ActorMetadata, ActorCapability};
