// TODO generation.md Step 18: Refactor this module according to the plan.
// - Define core SMT traits (SparseMerkleTree, SmtStore) here or in causality-merkle-traits.
// - Adopt/Integrate implementation from valence-coprocessor/crates/smt.
// - Remove dependencies on causality-core if possible, depend on causality-types, causality-crypto, causality-db/causality-storage-*.
// - Ensure this crate provides the primary SMT implementation.

//! Sparse Merkle Tree utilities.
//!
//! Provides traits and implementations for Sparse Merkle Trees (SMTs),
//! often used for maintaining verifiable state.
