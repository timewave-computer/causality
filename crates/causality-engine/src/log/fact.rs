// Content-addressed fact implementation
// Original file: src/log/content_addressed_fact.rs
...
use causality_crypto::{ContentAddressedStorage, StorageError};
...
impl FactRegistryFactory {
    ...
    pub fn create_memory_registry() -> Arc<ContentAddressedFactRegistry> {
        let storage = causality_crypto::StorageFactory::create_memory_storage();
...
mod tests {
    use super::*;
    use causality_crypto::InMemoryStorage;
