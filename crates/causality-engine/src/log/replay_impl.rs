...
// Original file: src/log/replay.rs
...
impl ReplayOptions {
    ...
    pub fn with_resources(mut self, resources: std::collections::HashSet<causality_types::ContentId>) -> Self {
        self.resources = Some(resources);
        self
    }
    
    /// Set the domains to include
    pub fn with_domains(mut self, domains: std::collections::HashSet<causality_types::DomainId>) -> Self {
