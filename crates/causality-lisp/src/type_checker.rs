...
mod tests {
    ...
    fn test_capability_enforcement() {
        use causality_core::effect::{Capability, FieldType, RecordType, RowType};
        ...
        checker_no_caps
            .type_env
            .bind_type("person".to_string(), record_type.clone());
        ...
        let mut checker_read_only =
            TypeChecker::with_capabilities(vec![Capability::read_field(
                "person_read",
                "name",
            )]);
        checker_read_only
        ...
        checker_with_write
            .type_env
            .bind_type("person".to_string(), record_type);
