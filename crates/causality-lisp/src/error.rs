...
pub enum ParseError {
    ...
    UnexpectedEofInConstruct { construct: String, hint: String },
...
impl ParseError {
    ...
    pub fn wrong_argument_count(
        ...
        let issue = if found > expected.parse::<usize>().unwrap_or(0) {
            "many"
        } else {
            "few"
        };
