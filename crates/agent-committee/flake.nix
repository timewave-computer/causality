# crates/agent-committee/flake.nix
{
  description = "Committee Agent for Causality Simulation";
  ...
  outputs = { self, nixpkgs, flake-utils, rust-overlay, causality }:
    ...
    in {
      packages.default = rustPlatform.buildRustPackage {
        pname = "causality-agent-committee";
        version = "0.1.0";
      ...
      apps.default = {
        type = "app";
        program = "${self.packages.${system}.default}/bin/agent-committee";
      };
    });
} 