...
impl ValenceAnalyzer {
    ...
    fn analyze_create_account(&mut self, args: &[Expr]) -> Result<()> {
        ...
        self.effect_dependencies
            .push("account_creation".to_string());
    ...
    fn analyze_approve_library(&mut self, args: &[Expr]) -> Result<()> {
        ...
        self.effect_dependencies
            .push("library_approval".to_string());
    ...
    fn analyze_submit_transaction(&mut self, args: &[Expr]) -> Result<()> {
        ...
        self.effect_dependencies
            .push("transaction_submission".to_string());
...
mod tests {
    use super::*;
    use causality_core::lambda::symbol::Symbol;
    ...
    fn create_apply_expr(func_name: &str, args: Vec<Expr>) -> Expr {
        Expr {
            kind: ExprKind::Apply(Box::new(create_symbol_expr(func_name)), args),
            ty: None,
            span: None,
        }
    }
    ...
    fn test_create_account_analysis() {
        ...
        let expr = create_apply_expr(
            "create_account",
            vec![create_string_literal_expr("owner_keypair")],
        );
        ...
        assert!(result
            .effect_dependencies
            .contains(&"account_creation".to_string()));
    }
    ...
    fn test_approve_library_analysis() {
        ...
        assert!(result
            .effect_dependencies
            .contains(&"library_approval".to_string()));
    }
    ...
    fn test_submit_transaction_analysis() {
        ...
        assert!(result
            .effect_dependencies
            .contains(&"transaction_submission".to_string()));
    }
    ...
    fn test_complex_program_analysis() {
        ...
        let create_account = create_apply_expr(
            "create_account",
            vec![create_string_literal_expr("my_keypair")],
        );

        let approve_library = create_apply_expr(
            "approve_library",
            vec![
                create_string_literal_expr("my_account"),
                create_string_literal_expr("SwapLibrary"),
        ...
        let submit_transaction = create_apply_expr(
            "submit_transaction",
            vec![
                create_string_literal_expr("my_account"),
