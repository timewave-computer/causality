...
// Update crate paths for moved code
use causality_ir::graph::TemporalEffectGraph;
use causality_ir::effect_node::EffectNode; // Assuming EffectNode is still needed from IR
use causality_ir::resource_node::ResourceNode; // Assuming ResourceNode is still needed from IR

// Use the generation framework from causality_codegen_core
