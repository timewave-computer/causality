...
// Original file: src/resource/authorization.rs
...
use causality_resource::{Capability, CapabilityType, Right};
use causality_resource_manager::{ResourceRegisterLifecycleManager, RegisterOperationType};
use causality_types::{Error, Result};
use causality_resource_system::AuthorizationService;
use causality_crypto::{HashFactory, ContentId};
