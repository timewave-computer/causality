// Fact observation for resources
// Original file: src/resource/fact_observer.rs
...
use causality_engine::{FactLogger, FactMetadata};
use causality_engine_types::{FactType, RegisterFact};
use crate::resource::register::{Register, RegisterState, OperationType};
use causality_crypto::ContentId;
use causality_types::{TraceId, DomainId, BlockHeight};
...
mod tests {
    ...
    fn create_test_register() -> Register {
        Register::new(
            ContentId::new("unique-id"),
            causality_types::Address::new("owner1"),
            causality_types::Domain::new("domain1"),
