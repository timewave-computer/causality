...
// Original file: src/resource/capability/validation.rs
...
mod tests {
    ...
    fn test_validate_delegation_chain() -> Result<()> {
        ...
        let delegation = auth_service.delegate_capability(
            causality_resource::Delegation::new(
                address.clone(),
                delegate.clone(),
                resource_id.clone(),
                right,
