// Capability delegation mechanics
// Original file: src/resource/capability/delegation.rs
...
impl DelegationManager {
    ...
    ///
    /// This method creates a new capability from a template, with a new resource ID.
...
mod tests {
    use super::*;
    use causality_resource::test_utils::MockCapabilityRepository;
    ...
    fn create_test_setup() -> (
        ...
        let manager = DelegationManager::new(Arc::clone(&repo));
        let owner = Address::new("test-owner");
        let resource_id = ContentId::from("test-resource".as_bytes());
    ...
    fn test_capability_template() -> Result<()> {
        ...
        let new_resource = ContentId::from("new-resource".as_bytes());
