// Temporal consistency for resources
// Original file: src/resource/resource_temporal_consistency.rs
...
use causality_resource::ResourceManager;
use causality_resource_manager::ResourceRegisterLifecycleManager;
use causality_resource::{RelationshipTracker, ResourceRelationship, RelationshipType, RelationshipDirection};
use causality_patterns::{RelationshipQueryExecutor, RelationshipQuery};
...
pub struct ResourceTemporalConsistency {
    ...
    resource_snapshots: HashMap<ContentId, Vec<ResourceTimeSnapshot>>,
...
impl ResourceTemporalConsistency {
    ...
    pub fn synchronize_resource_registers(
        &mut self,
        ...
        let resource_ids: Vec<ContentId> = resource_manager.list_resources()?;
