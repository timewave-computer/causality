// Content-addressed resource registry
// Original file: src/resource/content_addressed_register.rs
...
use causality_crypto::{ContentAddressed, HashOutput, ContentId, HashFactory, HashError};
