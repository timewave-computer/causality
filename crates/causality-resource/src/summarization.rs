// Resource state summarization
// Original file: src/resource/summarization.rs
...
use causality_resource::{EpochId, SummaryGroup};
use causality_types::{Address, Domain, Hash256};
