...
// Original file: src/resource/storage.rs
...
use causality_resource::{ResourceRegister, StateVisibility};
...
impl StorageStrategy {
    ...
    pub fn fully_on_chain() -> causality_resource::StorageStrategy {
    ...
    pub fn to_unified_strategy(&self) -> causality_resource::StorageStrategy {
        match self {
            StorageStrategy::OnChain => {
                causality_resource::StorageStrategy::FullyOnChain {
                    visibility: StateVisibility::Public,
            ...
            StorageStrategy::ReadOnly => {
                causality_resource::StorageStrategy::ReadOnly {
                    commitment: None,
                    nullifier: None,
                }
            },
