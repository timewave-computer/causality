...
// Original file: src/resource/versioning.rs
...
use causality_types::{ContentHash, Hash256};
...
mod tests {
    ...
    fn test_register_migration() {
        ...
        let mut register = Register {
            ...
            owner: causality_types::Address::new("owner"),
            domain: causality_types::Domain::new("test_domain"),
