// Content-addressed resource implementation
// Original file: src/resource/content_addressed_resource.rs
...
impl Resource {
    ...
    pub fn from_resource_register(register: &ResourceRegister) -> Self {
        ...
        let resource_type = match &register.resource_logic {
            causality_resource::ResourceLogic::Custom(t) => t.clone(),
            causality_resource::ResourceLogic::Fungible => "fungible".to_string(),
            causality_resource::ResourceLogic::NonFungible => "non-fungible".to_string(),
            causality_resource::ResourceLogic::Capability => "capability".to_string(),
            causality_resource::ResourceLogic::Data => "data".to_string(),
        };
