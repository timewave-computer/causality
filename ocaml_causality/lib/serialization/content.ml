...
let verify_resource_address (resource : resource) (expected_address : bytes) :
    bool =
...
module ContentRegistry = struct
  ...
  let register_resource registry resource =
    ...
    registry.resource_addresses <-
      (address, resource) :: registry.resource_addresses;
    address
