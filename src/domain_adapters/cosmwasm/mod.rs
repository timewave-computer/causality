...
// allowing Timewave to interact with smart contracts deployed on these chains.
...
pub fn create_cosmwasm_adapter(config: CosmWasmAdapterConfig) -> crate::error::Result<CosmWasmAdapter> {
