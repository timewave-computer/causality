...
impl ContentAddressedDomainInterface for ContentAddressedDomainRegistry {
    async fn resolve_content(&self, domain_id: &DomainId, id: &ContentId) -> std::result::Result<Vec<u8>, CrossDomainError> {
        ...
        match result.0 {
            crate::domain::types::FactType::Binary(data) => Ok(data),
    ...
    async fn verify_content<T: ContentAddressed + Send + Sync>(
        ...
        let root_hash = match result.0 {
            crate::domain::types::FactType::Binary(data) => {
                if data.len() != 32 {
                    return Err(CrossDomainError::VerificationFailed(
    ...
    async fn query_content(
        ...
        match result.0 {
            crate::domain::types::FactType::String(data) => {
            ...
            crate::domain::types::FactType::Json(json) => {
...
mod tests {
    ...
    impl DomainAdapter for MockDomainAdapter {
        ...
        async fn domain_info(&self) -> Result<crate::domain::types::DomainInfo> {
            todo!()
        }
        ...
        async fn observe_fact(&self, query: &crate::domain::FactQuery) -> crate::domain::types::FactResult {
