...
use crate::crypto::hash::{ContentAddressed, ContentId, HashOutput, HashError, HashAlgorithm};
use crate::crypto::smt::{MerkleSmt, SmtKeyValue, SmtError, H256};
...
mod tests {
    use super::*;
    use crate::crypto::hash::{HashFactory, HashAlgorithm};
