...
use crate::crypto::hash::{DeferredHashId, HashAlgorithm, HashFunction, HashOutput, HashError};
...
impl DeferredHashingContext {
    ...
    pub fn default() -> Result<Self, HashError> {
        use crate::crypto::hash::{HashFactory, Blake3HashFunction};
        ...
        {
            use crate::crypto::hash::PoseidonHashFunction;
            hash_functions.insert(
...
impl crate::crypto::hash::DeferredHashing for DeferredHashingContext {
