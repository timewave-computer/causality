...
use crate::execution::context::{ExecutionContext, ContextId};
use crate::snapshot::{ExecutionSnapshot, SnapshotError, SnapshotId, SnapshotManager};
...
impl IncrementalSnapshotManager {
    ...
    fn compute_call_stack_changes(
        &self,
        parent_stack: &[crate::execution::context::CallFrame],
        child_stack: &[crate::execution::context::CallFrame],
    ) -> CallStackChanges {
...
mod tests {
    use super::*;
    use crate::snapshot::FileSystemSnapshotManager;
