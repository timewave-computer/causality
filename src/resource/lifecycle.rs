...
use crate::resource::lifecycle_manager::{ResourceRegisterLifecycleManager, StateTransitionRecord, RegisterOperationType};
...
impl ResourceLifecycle {
    ...
    pub fn can_perform_operation(&self, resource: &ResourceRegister, operation: &ResourceOperation) -> Result<bool> {
        ...
        let operation_type = match operation {
            ResourceOperation::Create => Ok(crate::resource::lifecycle_manager::RegisterOperationType::Create),
            ResourceOperation::Update => Ok(crate::resource::lifecycle_manager::RegisterOperationType::Update),
            ResourceOperation::Lock => Ok(crate::resource::lifecycle_manager::RegisterOperationType::Lock),
            ResourceOperation::Unlock => Ok(crate::resource::lifecycle_manager::RegisterOperationType::Unlock),
            ResourceOperation::Freeze => Ok(crate::resource::lifecycle_manager::RegisterOperationType::Freeze),
            ResourceOperation::Unfreeze => Ok(crate::resource::lifecycle_manager::RegisterOperationType::Unfreeze),
            ResourceOperation::Consume => Ok(crate::resource::lifecycle_manager::RegisterOperationType::Consume),
            ResourceOperation::Archive => Ok(crate::resource::lifecycle_manager::RegisterOperationType::Archive),
        }?;
