...
mod tests {
    ...
    fn create_test_fact() -> FactEntry {
        FactEntry {
            domain: crate::types::DomainId::new(1),
            block_height: crate::types::BlockHeight::new(100),
            block_hash: None,
            observed_at: crate::types::Timestamp::now(),
    ...
    fn create_test_result() -> ReplayResult {
        ReplayResult {
            status: crate::log::replay::ReplayStatus::Complete,
            processed_entries: 1,
            start_time: Utc::now(),
