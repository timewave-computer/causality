...
impl LogEntry {
    ...
    /// Create a new event entry with content hash - simplified version
    pub fn new_event(
    ...
    /// Create a new fact entry with content hash - simplified version
    pub fn new_fact(
        resource_id: &ResourceId,
        domain_id: &DomainId,
        fact_type: &str,
    ...
    /// Create a new effect entry with content hash - simplified version
    pub fn new_effect(
        resource_id: &ResourceId,
        domain_id: &DomainId,
        effect_type_str: &str,
...
use crate::crypto::hash::ContentId;;
    ...
    fn test_entry_factory_methods() {
        // Test the new_event factory method
        ...
        // Test the new_fact factory method
        ...
        // Test the new_effect factory method
